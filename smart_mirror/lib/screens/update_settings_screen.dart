...
class _updateScreenState extends State<updateScreen> {
  ...
  final TextEditingController
      _confirmpasswordTextController = //  for confirm password
      TextEditingController();
  ...
  Widget build(BuildContext context) {
    return /*  MaterialApp(
      ...
      appBar: AppBar(
        ...
        title: const Text('Sign-In Settings'), //  for title
      ...
      body: Stack(
        children: <Widget>[
          ...
          Container(
              ...
              height:
                  MediaQuery.of(context).size.height, //media query for height
              child: SingleChildScrollView(
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    reusableTextField(
                        "Enter New Password",
                        Icons.lock_outlined, //  for new password
                        true,
                    ...
                    updateButton(context, () async {
                      if (_passwordTextController.text.isEmpty) {
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(
                            content: Text(
                                'Please enter the old password.'), //  if old password is empty
                          ),
                        );
                        return;
                      }
                      if (_newPasswordTextController.text.isEmpty) {
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(
                            content: Text(
                                'Please enter a new password.'), //  if new password is empty
                          ),
                        );
                        return;
                      }
                      ...
                      if (_newPasswordTextController.text !=
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(
                            content: Text(
                                'Passwords do not match.'), //  if new password and confirm password do not match
                          ),
                        );
                        return;
                      }
                      ...
                      if (flag == true) {
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(
                            content: Text(
                                'Wrong password provided.'), // if wrong password is provided
                          ),
                        );
                      } else {
                        _logOut();
                    ...
                    reusableTitleField(
                        "DELETE ACCOUNT", false), //  for delete account
                    reusableTitleField(
